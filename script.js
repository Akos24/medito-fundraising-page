...
let titleDescription = "Help us build a larger Medito community! Contribute to our ad campaign for unity, peace, and connection. Your support brings positive change. Join us today!";

// Set fundraising details in the HTML
document.querySelector(".fundraisingTitle").innerHTML = currentGoal;
document.querySelector(".fundraisingDescription").innerHTML = titleDescription;
...
function handleDonation() {
    ...
    let donationAmount = document.getElementById("amountInput").value;
...
// Fetch recent donations from an API
